...
const cache = new Map();
import { MBTGroup, MBTIfGroup, MBTLink, MBTAW, MBTSection, MBTEndEvent, MBTExclusiveGateway, MBTParallelGateway, MBTStartEvent } from '@/composables/customElements'
...
Object.assign(joint.shapes, { itea: { mbt: { test: { MBTGroup, MBTIfGroup, MBTLink, MBTAW, MBTSection, MBTStartEvent, MBTEndEvent, MBTExclusiveGateway, MBTParallelGateway } } } })
