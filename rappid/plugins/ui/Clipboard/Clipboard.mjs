...
export const Clipboard = Backbone.Collection.extend({
    ...
    copyElements: function(selection, graph, opt) {
        ...
        const originalElements = Array.isArray(selection) ? selection : selection.toArray();

        const cells = util.sortBy(Object.values(graph.cloneSubgraph(originalElements, opt)), cell => cell.attributes.z || 0);
