	...
	var Tooltip = core_mjs.mvc.View.extend({
	  ...
	  init: function init() {
	    ...
	    var _this$options = this.options,
	      ...
	      rootTarget = _this$options.rootTarget,
	      target = _this$options.target,
	      _this$options$animati = _this$options.animation,
	      animation = _this$options$animati === void 0 ? false : _this$options$animati,
	  ...
	  animate: function animate() {
	    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	      ...
	      duration = _ref$duration === void 0 ? '500ms' : _ref$duration,
	      _ref$delay = _ref.delay,
	      delay = _ref$delay === void 0 ? '400ms' : _ref$delay,
	   ...
	   * @returns {Object}
	   */
	  getTooltipSettings: function getTooltipSettings(el) {
	   ...
	   */
	  unbindHideActions: function unbindHideActions(element) {
	   ...
	   * @param {Element} element
	   */
	  bindHideOnRemoveTarget: function bindHideOnRemoveTarget(element) {
	    clearInterval(this.interval);
	   ...
	   * @param {Element} element
	   */
	  bindHideActions: function bindHideActions(element) {
	    var settings = this.settings;
	    var $element = $(element);
	    var hideActionsNamespace = this.eventNamespace + '.remove';
	   ...
	   * @returns {Object}
	   */
	  evaluateOptions: function evaluateOptions(element, elementDefinition) {
	   ...
	   * @returns {Object}
	   */
	  loadDefinitionFromElementData: function loadDefinitionFromElementData(element) {
	    if (!element) {
	      return {};
	    }
	    var isIgnored = function isIgnored(key) {
	   ...
	   * @returns {{string:*}}
	   */
	  getAllAttrs: function getAllAttrs(element, namePrefix) {
	   ...
	   */
	  normalizePosition: function normalizePosition(options) {
	   ...
	   */
	  position: function position(targetBBox) {
	    var settings = this.settings;
	    ...
	    this.$('.tooltip-arrow, .tooltip-arrow-mask').removeAttr('style') // Reset style of previous tooltip
	   ...
	   */
	  getViewportViewBBox: function getViewportViewBBox() {
	    var settings = this.settings;
	  ...
	  basePositions: {
	    left: function left(manipulable, opt) {
	      var position = {
	    ...
	    right: function right(manipulable, opt) {
	      var position = {
	    ...
	    top: function top(manipulable, opt) {
	      var position = {
	    ...
	    bottom: function bottom(manipulable, opt) {
	      var position = {
	        x: opt.targetBBox.x + opt.targetBBox.width / 2 - opt.tooltipBBox.width / 2,
	   ...
	   */
	  getTooltipBBox: function getTooltipBBox(targetBBox, containerBBox) {
	    var settings = this.settings;
	   ...
	   * @returns {{width: number, height: number}}
	   */
	  measureTooltipElement: function measureTooltipElement() {
	    var $measure = this.$el.clone().appendTo($('body')).css({
	      'left': -1000,
	      top: -500
	    });
	    var dimensions = {
