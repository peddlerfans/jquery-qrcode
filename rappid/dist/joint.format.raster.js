...
(function (exports, core_mjs, $) {
	...
	*/
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject(IteratorPrototype) || fails(function () {
	  ...
	  return IteratorPrototype[ITERATOR$4].call(test) !== test;
	});
	...
	if (!isCallable(IteratorPrototype[ITERATOR$4])) {
	  defineBuiltIn(IteratorPrototype, ITERATOR$4, function () {
	    return this;
	  });
	}
	    ...
	    if (CurrentIteratorPrototype !== Object.prototype && CurrentIteratorPrototype.next) {
	      if ( objectGetPrototypeOf(CurrentIteratorPrototype) !== IteratorPrototype$2) {
	        if (objectSetPrototypeOf) {
	          ...
	          defineBuiltIn(CurrentIteratorPrototype, ITERATOR$5, returnThis$1);
	        }
	      }
	 ...
	 */
	var toDataURL = function toDataURL(paper, callback) {
	 ...
	 * @param {Object} opt
	 */
	var toPNG = function toPNG(paper, callback, opt) {
	 ...
	 * @param {Object} opt
	 */
	var toJPEG = function toJPEG(paper, callback, opt) {
	 ...
	 * @param {Object} opt
	 */
	var toCanvas = function toCanvas(paper, callback, opt) {
	 ...
	 * @param paper
	 */
	var openAsPNG = function openAsPNG(paper, opt) {
	  var windowFeatures = 'menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes';
	...
	core_mjs.dia.Paper.prototype.openAsPNG = function (opt) {
	  return openAsPNG.apply(this, [this].concat(Array.prototype.slice.call(arguments)));
	};
	core_mjs.dia.Paper.prototype.toJPEG = function (callback, opt) {
	  return toJPEG.apply(this, [this].concat(Array.prototype.slice.call(arguments)));
	};
	core_mjs.dia.Paper.prototype.toPNG = function (callback, opt) {
	  return toPNG.apply(this, [this].concat(Array.prototype.slice.call(arguments)));
	};
	core_mjs.dia.Paper.prototype.toDataURL = function (callback, opt) {
	  return toDataURL.apply(this, [this].concat(Array.prototype.slice.call(arguments)));
	};
	core_mjs.dia.Paper.prototype.toCanvas = function (callback, opt) {
	  return toCanvas.apply(this, [this].concat(Array.prototype.slice.call(arguments)));
	};
