...
(function (exports, core_mjs) {
	...
	*/
	...
	function constructTree(parent) {
	  ...
	  var childrenKey = opt.children,
	    makeElement = opt.makeElement,
	    makeLink = opt.makeLink;
	  var children = core_mjs.util.isFunction(childrenKey) ? childrenKey(parent) : parent[childrenKey || 'children'];
	  if (!parentElement) {
	    parentElement = makeElement(parent, null);
	    collector.push(parentElement);
	  }
	  core_mjs.util.toArray(children).forEach(function (child) {
	    var childElement = makeElement(child, parentElement);
	    var link = makeLink(parentElement, childElement);
	...
	var Dijkstra = function Dijkstra(adjacencyList, source, weight) {
	...
	core_mjs.dia.Graph.prototype.constructTree = function (parent, opt) {
...
}(this.joint.graphUtils = this.joint.graphUtils || {}, joint));
