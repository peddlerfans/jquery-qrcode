...
(function (exports, $, core_mjs) {
	...
	*/
	...
	var Lightbox = Dialog.extend({
	  className: Dialog.prototype.className + ' lightbox',
	  options: core_mjs.util.merge({}, Dialog.prototype.options, {
	    closeButton: true,
	    modal: true,
	    downloadable: false,
	    ...
	    windowArea: .8,
	    // The maxium percentage of the window that is covered by lightbox.
	    openAnimation: false
	  }),
	  init: function init() {
	    ...
	    this.on('close:animation:complete', function () {
	      Dialog.prototype.close.apply(_this, _arguments);
	    });
	  },
	  open: function open() {
	  ...
	  positionAndScale: function positionAndScale() {
	  ...
	  startCloseAnimation: function startCloseAnimation() {
	  ...
	  startOpenAnimation: function startOpenAnimation() {
	    this.$el.animate(core_mjs.util.assign({}, this.options.openAnimation.properties, {
