...
(function (exports) {
	...
	*/
	...
	var toCellsArray = function toCellsArray(xmlString, makeElement, makeLink) {
	  ...
	  nodes.forEach(function (node) {
	    ...
	    var sizeNode = node.querySelector('size');
	    if (sizeNode) {
	      var size = parseFloat(sizeNode.getAttribute('value'));
	      data.width = size;
	      data.height = size;
	    }

	    // <viz:position x="15.783598" y="40.109245" z="0.0"/>
	    var positionNode = node.querySelector('position');
	    if (positionNode) {
	      var x = parseFloat(positionNode.getAttribute('x'));
	      var y = parseFloat(positionNode.getAttribute('y'));
	      var z = parseFloat(positionNode.getAttribute('z'));
	      data.x = x;
	      data.y = y;
	      data.z = z;
	    }
	    ...
	    var shapeNode = node.querySelector('shape');
	    if (shapeNode) {
	      var shape = shapeNode.getAttribute('value');
	      data.shape = shape;
	    }

	    // <viz:color r="239" g="173" b="66" a="0.6"/>
	    var colorNode = node.querySelector('color');
	    if (colorNode) {
	      var r = colorNode.getAttribute('r');
	      var g = colorNode.getAttribute('g');
	      var b = colorNode.getAttribute('b');
	      var a = colorNode.getAttribute('a');
	      if (a) {
	        data.color = "rgba(".concat(r, ",").concat(g, ",").concat(b, ",").concat(a, ")");
	      } else {
	        data.color = "rgb(".concat(r, ",").concat(g, ",").concat(b, ")");
	      }
	    }
	    var element = makeElement(data, node);
	    cells.push(element);
	  });
