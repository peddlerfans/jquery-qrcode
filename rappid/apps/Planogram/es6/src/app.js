...
export const init = () => {
    ...
    const productsStencil = new ui.Stencil({
        ...
        layout: (graph, group) => {
            return layout.GridLayout.layout(graph, Object.assign({ marginY: 20, marginX: 20, rowGap: 20, horizontalAlign: 'middle', verticalAlign: 'middle' }, group.layout));
        },
    ...
    const stencilEventMap = (stencil) => {
        return {
            ...
            'element:dragend': function (cloneView, evt) {
